...
% Last Modified by GUIDE v2.5 21-Jul-2021 00:51:51
...
bm=str2num(get(handles.edit4,'String'));
wa=(2*pi*a);
Ta=1/a;
...
t=0:Ta/999:10*Ta;
%demodulation
y1=am*bm*bm*(cos(wa*t).*cos(wc*t)).*cos(wc*t);
axes(handles.axes1);
plot(t,y1);
grid on;
...
am=2*am;
%reconsruction
y2=(am*(cos(wa*t).*cos(wc*t)).*cos(wc*t))-((am/4)*cos((2*wc+wa)*t))-((am/4)*cos((2*wc-wa)*t));
axes(handles.axes1);
plot(t,y2);
grid on;
