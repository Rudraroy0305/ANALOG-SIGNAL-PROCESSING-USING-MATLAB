...
% Last Modified by GUIDE v2.5 21-Jul-2021 00:08:08
...
fm=str2num(get(handles.edit1,'String'));
...
ac=str2num(get(handles.edit4,'String'));
...
y=ac*cos(2*pi*fc.*t+((B/(2*pi*fm))*am*sin(2*pi*fm.*t)));
axes(handles.axes1);
plot(t,y);
...
y=cos(2*pi*fc.*t+((B/(2*pi*fm))*sin(2*pi*fm.*t)));
z=am/(B/(2*pi*fm))*fmdemod(y,fc,fs,1);
axes(handles.axes1);
plot(t,z);
